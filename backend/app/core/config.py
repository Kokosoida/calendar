...
class Settings(BaseSettings):
    ...
    MAX_EVENT_DURATION_MINUTES = 60 * 24
    MAX_EVENT_DURATION = relativedelta(minutes=MAX_EVENT_DURATION_MINUTES)

    MAX_INTERVAL_DURATION_MINUTES = 60 * 24 * 90
